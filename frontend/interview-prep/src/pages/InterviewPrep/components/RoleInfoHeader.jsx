    ...
    <div className="bg-white relative">
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div className="w-[40vw] md:w-[30vw] h-[200px] flex items-center justify-center bg-white overflow-hidden absolute top-0 right-0">
          <div className="w-16 h-16 bg-[#A7F3D0] blur-[65px] animate-blob1" />
          <div className="w-16 h-16 bg-[#99F6E4] blur-[65px] animate-blob2" />
          <div className="w-16 h-16 bg-[#BAE6FD] blur-[45px] animate-blob3" />
          <div className="w-16 h-16 bg-[#FBCFE8] blur-[45px] animate-blob1" />
        </div>
      </div>
    </div>
  )
